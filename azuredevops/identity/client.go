...
import (
	...
	"github.com/Nataliia5722/azure-devops-go-api/azuredevops/delegatedauthorization"
...
type Client interface {
	...
	// [Preview API]
	ReadMembers(context.Context, ReadMembersArgs) (*Team, error)
	// [Preview API]
